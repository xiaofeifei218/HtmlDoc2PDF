...
##### update\_message: dict\[str, str|int\], Required
...
##### document\_list: list\[dict\], Required
...
##### update\_message: dict\[str, str|dict\[\]\], Required
...
##### create\_time\_from: int

Unix timestamp for filtering documents created after this time. 0 means no filter. Defaults to 0.

##### create\_time\_to: int
...
##### document\_ids: list\[str\], Required
...
##### update\_message: dict\[str, str|list\[str\]|int\] Required
...
##### dataset\_ids: list\[str\], Required
...
##### vector\_similarity\_weight: float
...
##### update\_message: dict\[str, str|list\[str\]|dict\[\]\], Required
...
##### update\_message: dict\[str, Any\], Required
